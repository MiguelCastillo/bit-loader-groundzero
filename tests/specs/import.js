define(["dist/mloader", "sinon"], function(MLoader, sinon) {
  var Importer = MLoader.Import;
  ...
  describe("Import Suite", function() {
    ...
    describe("When importing module `yes` using the `load` interface", function() {
      ...
      describe("and module defines `code`", function() {
        ...
        beforeEach(function() {
          modYes   = new MLoader.Module({name: 'yes', type: MLoader.Module.Type.AMD, code: "module code"});
          loadStub = sinon.stub().returns(MLoader.Promise.resolve(modYes));
      ...
      describe("and module defines `factory`", function() {
        ...
        beforeEach(function() {
          ...
          modYes   = new MLoader.Module({name: 'yes', type: MLoader.Module.Type.AMD, factory: modFactoryStub});
          loadStub = sinon.stub().returns(MLoader.Promise.resolve(modYes));
      ...
      describe("and module defines `factory` with dependencies `no` and `maybe`", function() {
        ...
        beforeEach(function() {
          ...
          modYes = new MLoader.Module({
            name: 'yes',
            type: MLoader.Module.Type.AMD,
