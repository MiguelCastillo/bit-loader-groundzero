define(["dist/mloader", "sinon"], function(MLoader, sinon) {
  ...
  describe("Loader Suite", function() {
    ...
    describe("When loading a module from context.loaded", function() {
      ...
      beforeEach(function() {
        modFetchStub = sinon.stub().returns(MLoader.Promise.reject("Fetch must not be called when loading from `context.loaded`"));
        modYes = {};
        loader = new Loader({
          fetch: modFetchStub,
          context: {
    ...
    describe("When loading a module with `fetch`", function() {
      ...
      beforeEach(function() {
        ...
        modYesPromise = MLoader.Promise.resolve(moduleMeta);
